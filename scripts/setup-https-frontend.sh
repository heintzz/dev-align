...
#
# Prerequisites:
# 1. DNS A records pointing to this EC2 (18.141.166.14)
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}🔐 HTTPS Setup for ${DOMAIN}${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
server {
    listen 80;
    listen [::]:80;
    server_name devalign.site www.devalign.site;
...
echo -e "   ${GREEN}https://www.devalign.site${NC}"
echo ""
