...
export default function AppNavbar() {
  ...
  return (
    <header className="sticky top-0 z-40 flex justify-between h-24 items-center gap-4 border-b bg-tersier">
      <SidebarTrigger className="text-gray-700 hover:text-red-900" />
